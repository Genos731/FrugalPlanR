...
<body>
        ...
        <div class="row">
            ...
            <main class="col-sm-9 ml-sm-auto col-md-10 pt-3" role="main">
                ...
                <div class="alert alert-info alert-dismissible fade show" role="alert" id="explanation" style="display: none">
                    ...
                    This is the Expenses page where you can see a list of your expenses.
                </div>
    ...
    <script>    
    	function hideExplanation() {
    		localStorage.setItem('<c:out value="${userName}" /> expenses', true);
    	}
    	
    	if (!localStorage.getItem('<c:out value="${userName}" /> expenses')) $('#explanation').show();
    </script>
</body>
